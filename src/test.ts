...
//         protected sort:Sort,
//         protected aditionalQuery?:string
//     ) {
...
//     const assignatures = await getAssignatures(1,'ASC','idAssignature',filterQuery);
...
//         return await getAssignatures(page,order,column,'&hora=5');
//     }
...
// document.getElementById('hourAssignature')!.addEventListener('change',(e)=>{
    
//     const params = (<HTMLInputElement>e.target).value;
    
//     filterQuery = `&hora=${params}`;
